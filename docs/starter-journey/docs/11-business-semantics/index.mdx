...
- [ ] **Business Semantics**
    ...
    - [ ] [Hands-on lab](/docs/11-business-semantics/lab) — same KPI returns the same number in SQL, AI/BI, and Genie
...
* **Unity Catalog:** 
    ...
    * Contained inside a schema. Same level as tables, views, functions and models: [UC three-level namespace](/docs/02-before-you-start/foundations/unity-catalog#the-three-level-namespace).
