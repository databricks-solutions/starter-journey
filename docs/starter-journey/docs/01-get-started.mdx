...
| 8 | **[Automation & orchestration](/docs/08-orchestration/workspace)** | The pipeline running on a schedule with retries and notifications |
| 9 | **[Query and explore](/docs/09-query-and-explore)** | Interactive SQL queries running against your lakehouse data |
| 10 | **[Databricks AI/BI](/docs/10-databricks-aibi/dashboards)** | Dashboards, Genie Spaces, and apps surfacing data to business users |
| 11 | **[Business semantics](/docs/11-business-semantics/)** | **Self-paced** path to **activate** governed **metric views** and Genie-ready metadata, with a hands-on checkpoint across SQL, AI/BI, and Genie |
