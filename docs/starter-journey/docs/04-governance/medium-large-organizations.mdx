...
>
> **Prereqs:** [Small organizations](/docs/04-governance/small-organizations) (read this first, everything below builds on it)
...
- **Do next:** [Unity Catalog Setup](/docs/04-governance/unity-catalog-setup)
