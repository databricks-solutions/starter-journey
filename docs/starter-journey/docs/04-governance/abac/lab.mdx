...
>
> **Prereqs:** [13. Data Access Control](/docs/04-governance/abac/), a SQL warehouse or serverless cluster, `CREATE SCHEMA` on `development`
...
In production, `pii` would be a [governed tag](/docs/04-governance/abac/#governed-tags), so only stewards authorized by a tag policy can set these values. A plain tag works for this lab.
...
- **Do next:** [14. CI/CD and DevOps](/docs/07-operations/)
- **Learn why:** [Data Access Control overview](/docs/04-governance/abac/)
