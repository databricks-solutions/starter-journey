...
Add datasets from SQL on **`system.billing.usage`** joined to **`system.billing.list_prices`**. Start from [Databricks AI/BI dashboards](/docs/10-databricks-aibi/dashboards) and [Dashboards (AI/BI)](https://docs.databricks.com/aws/en/dashboards).
