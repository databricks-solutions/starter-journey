...
|------|-------|----------------|
| 1 | [Import usage dashboard](/docs/02-account-workspaces/workspace-settings/cost-monitoring/import-usage-dashboard) | Fastest visibility, straight from the account console, no SQL. |
| 2 | [Additional dashboards](/docs/02-account-workspaces/workspace-settings/cost-monitoring/additional-dashboards) | Optional packaged dashboards on your catalog and schema. |
| 3 | [Tags and attribution](/docs/02-account-workspaces/workspace-settings/cost-monitoring/tag-compute-and-jobs) | Forward-only labels for team and project rollups. |
| 4 | [Budget alerts](/docs/02-account-workspaces/workspace-settings/cost-monitoring/budget-alerts) | Account-level monthly monitors with email. |

## Next

- **Do next:** [Import usage dashboard](/docs/02-account-workspaces/workspace-settings/cost-monitoring/import-usage-dashboard)
