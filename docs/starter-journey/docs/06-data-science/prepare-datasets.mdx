...
>
> **Prereqs:** [Data science](/docs/06-data-science/), [Unity Catalog foundations](/docs/01-introduction/foundations/unity-catalog)
...
<StepGuide
  description="Install the Feature Store dbdemo in a notebook, then explore the three notebooks it creates, from feature basics to production pipelines."
  minutes={15}
  referenceHref="https://www.databricks.com/resources/demos/tutorials/data-science-and-ai/feature-store-and-online-inference"
  referenceLabel="Feature Store and Online Inference (Demo Center)">

<Step>

Install the demo from the dbdemos library. Run the following cells in a new Python notebook.
...
Explore the installed notebooks. The demo installs three that build on each other:
...
- **Do next:** [Data science overview](/docs/06-data-science/)
