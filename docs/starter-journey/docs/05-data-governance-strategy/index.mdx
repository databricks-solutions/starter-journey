...
:::warning
Before choosing a pattern, review **[Add Groups — How it works](/docs/03-infra-setup/add-groups/#how-it-works)** to understand the expected group structure that your data governance model will build on.
:::
