...
This section starts with the groups and ownership model, then gives you two namespace patterns.
Pick the pattern that matches your size.
...
:::warning
Before choosing a pattern, review **[how Groups works](/docs/05-data-governance-strategy/groups#how-it-works)** so you know the group structure this governance model builds on.
:::
...
Start with [Groups](/docs/05-data-governance-strategy/groups), then [assign Unity Catalog asset ownership](/docs/05-data-governance-strategy/uc-assets-ownership) to the admin group.
With the operating model in place, choose a namespace pattern:
