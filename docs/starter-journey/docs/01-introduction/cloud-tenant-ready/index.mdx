...
>
> **Prereqs:** [Foundations](/docs/01-introduction/foundations)
...
| Scenario | Setup |
|---|---|
| One cloud account, no plan to add more | [Single-tenant](/docs/01-introduction/cloud-tenant-ready/single-tenant-setup) |
| Multiple cloud accounts by environment or business unit | [Multi-tenant](/docs/01-introduction/cloud-tenant-ready/multi-tenant-setup) |
...
- **Do next:** [Single-tenant setup](/docs/01-introduction/cloud-tenant-ready/single-tenant-setup)
