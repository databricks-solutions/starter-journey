...
>
> **Prereqs:** [Account Console](/docs/01-introduction/foundations/account-console), [Workspace](/docs/01-introduction/foundations/workspace), [Unity Catalog](/docs/01-introduction/foundations/unity-catalog)
...
- **Do next:** [Cloud Tenant ready](/docs/01-introduction/cloud-tenant-ready)
- **Learn why:** [Unity Catalog](/docs/01-introduction/foundations/unity-catalog)
