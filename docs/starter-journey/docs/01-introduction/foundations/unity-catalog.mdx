...
>
> **Prereqs:** [Workspace](/docs/01-introduction/foundations/workspace)
...
- **Do next:** [Create your first workspace on AWS](/docs/02-account-workspaces/create-workspaces/aws/serverless)
