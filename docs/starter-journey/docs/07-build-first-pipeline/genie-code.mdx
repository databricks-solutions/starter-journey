---
sidebar_label: Genie Code
description: Build a Spark Declarative Pipeline using Genie Code in the Databricks Workspace.
---

# Genie Code

> **You'll learn** how to build a pipeline interactively using Genie Code in ~10 min.
>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/UO0wvGYu5QQ"></iframe>
