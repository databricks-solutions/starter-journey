...
| **[Workspace + Genie Code](/docs/07-build-first-pipeline/workspace-databricks-agent)** | Build interactively in the browser | You are still figuring out the transformation |
