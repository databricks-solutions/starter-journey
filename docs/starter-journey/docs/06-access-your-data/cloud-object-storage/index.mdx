...
Most of your data probably already sits in cloud object storage: S3 buckets, ADLS containers, GCS buckets.
Databricks needs a governed way to read and write it.
Skip that, and teams paste credentials into notebooks or set them at the cluster level, which sidesteps Unity Catalog completely.
Then nobody can tell you who touched what.

Think of it as a key and a door.
The key proves who you are.
The door decides what you can open.
Two Unity Catalog objects play those roles.
...
The external location and its grants decide who reaches which path.
