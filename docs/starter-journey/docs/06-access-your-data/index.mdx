...
| [Lakeflow Connect ingestion](/docs/06-access-your-data/managed-connectors) | You need to ingest data from external databases, SaaS apps, files, or streams into UC tables |
