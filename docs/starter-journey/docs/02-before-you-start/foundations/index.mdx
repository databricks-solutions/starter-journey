...
- **[Workspace](/docs/02-before-you-start/foundations/workspace)** — The environment where teams build and run data + AI workloads.
- **[Unity Catalog](/docs/02-before-you-start/foundations/unity-catalog)** — The governance layer for all data and AI assets.
- **[Recap and learning](/docs/02-before-you-start/foundations/recap-and-learning)** — Quick-check questions to verify you understood the core concepts.
