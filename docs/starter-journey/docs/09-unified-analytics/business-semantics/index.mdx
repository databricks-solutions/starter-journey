...
- [ ] **Business Semantics**
    ...
    - [ ] [Hands-on lab](/docs/09-unified-analytics/business-semantics/lab): the same KPI returns the same number in SQL, AI/BI, and Genie
- [ ] [12. Data Access Control](/docs/13-data-access-control/) (in progress)
- [ ] [13. CI/CD and DevOps](/docs/14-ci-cd-devops/) (in progress)
- [ ] [14. MLOps](/docs/10-predictive-analytics/) (in progress)
...
- **Do next:** [Hands-on lab](/docs/09-unified-analytics/business-semantics/lab), then [12. Data Access Control](/docs/13-data-access-control/) (in progress)
