...
Add `my_catalog.my_schema.orders_metrics` to a [Genie Agent](/docs/09-unified-analytics/databricks-aibi/genie-agents), then ask it in plain English:
...
- **Learn why:** [Genie Agents](/docs/09-unified-analytics/databricks-aibi/genie-agents), [AI/BI overview](/docs/09-unified-analytics/databricks-aibi/dashboards)
