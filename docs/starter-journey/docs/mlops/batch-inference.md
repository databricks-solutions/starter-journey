...
- A model registered in Unity Catalog (see [Save a Model to Unity Catalog](/docs/mlops/save-model-to-unity-catalog)).
...
- **Do next:** [Datasets as Feature Tables](/docs/mlops/prepare-datasets)
