---
sidebar_label: 12. Orchestration and Jobs
...
>
> **Prereqs:** [Build the first pipeline](/docs/03-data-access-etl/build-first-pipeline)
...
<StarterJourneyProgress currentLevel={7}/>
...
- **Learn why:** [Build the first pipeline](/docs/03-data-access-etl/build-first-pipeline)
