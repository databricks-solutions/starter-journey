...
|---|---|---|---|
| Manual | [Console wizard](/docs/03-infra-setup/create-workspaces/aws/manual) | [Azure portal](/docs/03-infra-setup/create-workspaces/azure/manual) | [Console wizard](/docs/03-infra-setup/create-workspaces/gcp/manual) |
| Terraform | [BYOVPC](/docs/03-infra-setup/create-workspaces/aws/terraform) | [VNet injection](/docs/03-infra-setup/create-workspaces/azure/terraform) | [BYOVPC](/docs/03-infra-setup/create-workspaces/gcp/terraform) |
| Private Link + Terraform (SRA) | [AWS SRA](/docs/03-infra-setup/create-workspaces/aws/sra) | [Azure SRA](/docs/03-infra-setup/create-workspaces/azure/sra) | [GCP SRA](/docs/03-infra-setup/create-workspaces/gcp/sra) |
