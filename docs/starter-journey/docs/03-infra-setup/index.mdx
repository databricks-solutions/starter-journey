...
- **[Add Groups](/docs/03-infra-setup/add-groups/manual)**: create groups that map to data personas and assign users to them.
- **[Set admin group](/docs/03-infra-setup/metastore-admins/set-admin-group)**: assign metastore administration to a group instead of one person.
