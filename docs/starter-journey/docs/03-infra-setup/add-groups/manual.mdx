...
>
> **Prereqs:** [Add Users](/docs/03-infra-setup/add-users/manual), [Add Groups overview](/docs/03-infra-setup/add-groups)
...
Create the full set your org needs. The [standard data personas](/docs/03-infra-setup/add-groups) list the recommended ones.
