...
- **[Set admin group](/docs/03-infra-setup/metastore-admins/set-admin-group)** — Transfer metastore ownership from an individual to the admin group.
- **[UC assets ownership](/docs/03-infra-setup/metastore-admins/uc-assets-ownership)** — Reassign existing catalogs, external locations, and credentials to the admin group.
