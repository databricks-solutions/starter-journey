...
>
> **Prereqs:** [Automation & Orchestration](/docs/12-orchestration/workspace)
...
| Page | What you'll do |
|---|---|
| [Dashboards](/docs/09-unified-analytics/databricks-aibi/dashboards) | Create and share visual reports backed by governed lakehouse tables. |
| [Genie Spaces](/docs/09-unified-analytics/databricks-aibi/genie-spaces) | Let business users ask data questions in natural language. |
